...
A floating text field, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/FloatingTextFieldSwiftUI.git
   ```
### Usage

1. How to create the floating text field view
